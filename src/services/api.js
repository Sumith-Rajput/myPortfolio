const API_BASE_URL = 'https://sumith-portfolio-api-gzghbqe7hhanb4er.southindia-01.azurewebsites.net/api' /* import.meta.env.VITE_API_URL || 'http://localhost:3001/api'; */
